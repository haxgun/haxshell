...
- Переключатель рабочих пространств, индикатор активного приложения и виджет погоды на панели.
...
- В Settings доступны параметры blur, границ, теней, palette, типографики, геометрии и отступов панели, положения всплывающих панелей, уведомлений, OSD и смены обоев.
