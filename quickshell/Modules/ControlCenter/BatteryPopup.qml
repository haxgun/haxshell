...
PanelWindow {
  ...
  readonly property bool batteryCharging: batteryPanel.batteryCharging
  readonly property bool acOnline: batteryPanel.acOnline
  function percent() { return batteryPanel.percent() }
